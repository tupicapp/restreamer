...
- Assumption: streamer-owned public artifact prefixes are neutral. Input artifacts resolve under `<prefix>/inputs/<input-id>/...`, and the streamer's primary switched output resolves under `<prefix>/output/...`.
